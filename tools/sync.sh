...
copy_dir() {
    ...
    # The laptop's private-home mode (0600) is an artifact of where a file lives, not an intention
    # about who may read it. These files are committed and baked into an image, so they are normal.
